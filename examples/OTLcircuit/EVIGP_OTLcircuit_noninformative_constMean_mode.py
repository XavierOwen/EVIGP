...
trainingResult_str = 'training for OTL circuit function, noninformative prior, constant mean model ends at epoch {epoch} using {time:d} seconds'.format(
    epoch=epoch,
    time = int(end-start)
)
...
np.save('RMSPE/OTLcircuit/GPEVI-OTL-ConstMean-nonInformativePrior-mode.npy',Retest_result)
