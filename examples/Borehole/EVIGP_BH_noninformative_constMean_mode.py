...
trainingResult_str = 'training for Borehole function, noninformative prior, constant mean model ends at epoch {epoch} using {time:d} seconds'.format(
    epoch=epoch,
    time = int(end-start)
)
...
np.save('RMSPE/Borehole/GPEVI-BH-ConstMean-nonInformativePrior-mode.npy',Retest_result)
