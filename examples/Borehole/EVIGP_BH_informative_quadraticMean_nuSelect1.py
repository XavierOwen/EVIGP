...
var_names = ['intercept',r'$x_1$',r'$x_2$',r'$x_3$',r'$x_4$',r'$x_5$',r'$x_6$',r'$x_7$',r'$x_8$',r'$x_1x_2$',r'$x_1x_3$',r'$x_1x_4$',r'$x_1x_5$',r'$x_1x_6$',r'$x_1x_7$',r'$x_1x_8$',
             r'$x_2x_3$',r'$x_2x_4$',r'$x_2x_5$',r'$x_2x_6$',r'$x_2x_7$',r'$x_2x_8$',r'$x_3x_4$',r'$x_3x_5$',r'$x_3x_6$',r'$x_3x_7$',r'$x_3x_8$',
             r'$x_4x_5$',r'$x_4x_6$',r'$x_4x_7$',r'$x_4x_8$',r'$x_5x_6$',r'$x_5x_7$',r'$x_5x_8$',r'$x_6x_7$',r'$x_6x_8$',r'$x_7x_8$',r'$x_1^2$',r'$x_2^2$',
             r'$x_3^2$',r'$x_4^2$',r'$x_5^2$',r'$x_6^2$',r'$x_7^2$',r'$x_8^2$']
...
plt.savefig("figs/Borehole/BH-EVIGP-QuadraticMean-mode-betaValues-nu"+str(nu)+".pdf", format="pdf", bbox_inches="tight")
...
np.save('RMSPE/Borehole/GPEVI-BH-QuadraticMean-informativePrior-mode-nuSelected1.npy',Retest_result)
