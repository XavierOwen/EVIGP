...
plt.savefig("figs/Toy/XSinX-EVIGP-LinearMean-mode-lnrhoWithPars.pdf", format="pdf", bbox_inches="tight")
...
plt.savefig("figs/Toy/XSinX-EVIGP-LinearMean-mode-withVar.pdf", format="pdf", bbox_inches="tight")
...
np.save('RMSPE/Toy/GPEVI-XSinX-LinearMean-nonInformativePrior-mode.npy',Retest_result)
