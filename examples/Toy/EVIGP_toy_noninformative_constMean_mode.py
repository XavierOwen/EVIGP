...
plt.savefig("figs/Toy/XSinX-EVIGP-ConstMean-mode-lnrhoWithPars.pdf", format="pdf", bbox_inches="tight")
...
plt.savefig("figs/Toy/XSinX-EVIGP-ConstMean-mode-withVar.pdf", format="pdf", bbox_inches="tight")
...
np.save('RMSPE/Toy/GPEVI-XSinX-ConstMean-nonInformativePrior-mode.npy',Retest_result)
