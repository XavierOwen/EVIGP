...
from EVIGP_utils.utils import Cal_G_constMean as Calc_G
...
plt.savefig("figs/Toy/XSinX-EVIGP-ConstMean-noDif-lnrhoWithPars.pdf", format="pdf", bbox_inches="tight")
...
plt.savefig("figs/Toy/XSinX-EVIGP-ConstMean-noDif-withVar.pdf", format="pdf", bbox_inches="tight")
...
np.save('RMSPE/Toy/GPEVI-XSinX-ConstMean-nonInformativePrior-noDif.npy',Retest_result)
